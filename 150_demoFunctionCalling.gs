...
function demoFunctionCalling() {
  ...
  if (message.hasOwnProperty('tool_calls')) {
    ...
    // 3.2 テキスト生成を関数化する 040_askSimpleChat.gs 1-37行 参照
 ...
 *
 * @param {Object.<string, string>} args - Gmailの検索クエリを格納したオブジェクト
 * @return {Array.<Object>} results - 日時、件名、本文を含むメール情報のオブジェクト配列
 */
 ...
 * 
 * @param {Object.<string, string>} args - 取得開始日時と終了日時を格納したオブジェクト
 * @return {Array.<Object>} eventObjs - カレンダーの予定情報オブジェクトの配列
 */
